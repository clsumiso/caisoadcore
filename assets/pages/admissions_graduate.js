...
function generateNOA(applicantID = "")
{
    ...
    $('[name="applicantID"]').val(applicantID);
}

function printNOA()
{
    window.open(window.location.origin + "/office-of-admissions/generate-noa/" + $('[name="applicantID"]').val() + "/" + $('[name="regSched"]').val().replace("/", "-") + "/" + $('[name="classSchedule"]').val().replace("/", "-") + "/" + ($('[name="remarks"]').val() == "" ? "strQuery" : $('[name="remarks"]').val()), "_BLANK");
    // $.ajax({
    //     url: window.location.origin + '/office-of-admissions/admission_application/generateNoa',
    //     type: "POST",
    //     data: 
    //     { 
    //         applicantID: $('[name="applicantID"]').val(),
    //         regSched: $('[name="regSched"]').val(),
    //         classStart: $('[name="classSchedule"]').val(),
    //         nonClsuGrad: $('[name="remarks"]').val()
    //     },
    //     success: function (response)
    //     {
    //         // data_privacy(applicantID) 
    ...
    //         swal({
    //             title: "Office of Admissions",
    //             text: "Something went wrong, please try again." + errorThrown,
    //             type: "info"
    //         });
    //     }
    // });
