                ...
                <div class="modal-body">
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-4 col-lg-4">
                            ...
                            <input class="form-control" type="text" name="lastname" id="lastname" placeholder="(e.g. Dela Cruz)" readonly>
                        </div>
                        <div class="col-sm-4 col-lg-4">
                            <b>Firstname <small class="col-red">*readonly</small></b>
                            <input class="form-control" type="text" name="firstname" id="firstname" placeholder="(e.g. Juan, Jr.)" readonly>
                        </div>
                        <div class="col-sm-4 col-lg-4">
                            <b>Middlename <small class="col-red">*readonly</small></b>
                            <input class="form-control" type="text" name="middlename" id="middlename" placeholder="(e.g. Doe)" readonly>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-sm-6 col-lg-6">
                            <b>Course (program) <small class="col-red">*readonly</small></b>
                            <input class="form-control" type="text" name="course" id="course" placeholder="Course" readonly>
                        </div>
                        <div class="col-sm-6 col-lg-6">
                            <b>Major</b>
