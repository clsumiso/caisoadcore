                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12 col-md-3 col-3">
                                        ...
                                        <select name="father_occupation" class="form-control">
                                            ...
                                            <option value="n/a" <?php echo set_select('father_occupation','n/a', ( !empty($data) && $data == "n/a" ? TRUE : FALSE )); ?>>n/a</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-md-3 col-3">
                                        ...
                                        <select name="father_education" class="form-control">
                                            ...
                                            <option value="n/a" <?php echo set_select('father_education','n/a', ( !empty($data) && $data == "n/a" ? TRUE : FALSE )); ?>>n/a</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-md-3 col-3">
                                        <b>Father Contact</b>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12 col-md-3 col-3">
                                        ...
                                        <select name="mother_age" class="form-control">
                                            ...
                                            <option value="n/a" <?php echo set_select('mother_age','n/a', ( !empty($data) && $data == "n/a" ? TRUE : FALSE )); ?>>n/a</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-md-3 col-3">
                                        <b>Occupation</b>
                                        <select name="mother_occupation" class="form-control">
                                            ...
                                            <option value="n/a" <?php echo set_select('mother_occupation','n/a', ( !empty($data) && $data == "n/a" ? TRUE : FALSE )); ?>>n/a</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-md-3 col-3">
                                        <b>Educational Attainment</b>
                                        <select name="mother_education" class="form-control">
                                            ...
                                            <option value="n/a" <?php echo set_select('mother_education','n/a', ( !empty($data) && $data == "n/a" ? TRUE : FALSE )); ?>>n/a</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-md-3 col-3">
                                        <b>Mother Contact</b>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12 col-md-3 col-3">
                                        ...
                                        <select name="guardian_age" class="form-control">
                                            ...
                                            <option value="n/a" <?php echo set_select('guardian_age','n/a', ( !empty($data) && $data == "n/a" ? TRUE : FALSE )); ?>>n/a</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-md-3 col-3">
                                        <b>Occupation</b>
                                        <select name="guardian_occupation" class="form-control">
                                            ...
                                            <option value="n/a" <?php echo set_select('guardian_occupation','n/a', ( !empty($data) && $data == "n/a" ? TRUE : FALSE )); ?>>n/a</option>
                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-md-3 col-3">
                                        <b>Educational Attainment</b>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-12 col-md-5 col-lg-5">
                                        <b>If No, Why?</b><br>
                                        <input type="text" name="living_with_parent_remarks" value="<?php echo set_value('living_with_parent_remarks'); ?>" class="form-control" placeholder="Living with parents">
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-sm-12 col-md-3 col-3">
