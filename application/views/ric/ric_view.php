                        ...
                        <div class="body">
                            <div>
                                ...
                                <div class="tab-content">
                                    <?php $this->load->view('ric/tab_menu/_home.php'); ?>

                                    <?php $this->load->view('ric/tab_menu/_evaluation.php'); ?>
                                    ...
                                    <?php $this->load->view('ric/tab_menu/_import.php'); ?>

                                    <?php $this->load->view('ric/tab_menu/_export.php'); ?>

                                    <?php $this->load->view('ric/tab_menu/_profile_settings.php'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
