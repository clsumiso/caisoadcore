...
class Admission_application extends CI_Controller
{
  ...
  public function generateNoa($applicantID = "", $registrationSchedule = "", $classStart = "", $nonClsuGrad = "")
  {
  ...
  public function processNoa($data = array())
  {
          ...
          <table style="margin-bottom: 0; width: 100%;">
            <tr>
              ...
              <td style="text-align: center; vertical-align: top; padding-top: 15px; width: 10%;">
                <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">Republic of the Philippines</p>
                <p style="font-family: tahoma; font-size: 12px; font-weight: bold;">CENTRAL LUZON STATE UNIVERSITY</p>
                <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">Science City of Muñoz, Nueva Ecija</p>
              </td>
              <td style="text-align: right; width: 30%;">
            ...
            <tr>
              ...
              <td style="text-align: center; padding-bottom: 25px;">
                <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">OFFICE OF ADMISSIONS</p>
              </td>
              <td style="text-align: right; width: 30%;"></td>
            </tr>
            <tr>
              <td style="text-align: right; width: 30%;"></td>
              <td style="text-align: center;">
                <p style="font-family: tahoma; font-size: 12px; font-weight: bold;">NOTICE OF ADMISSION</p>
              </td>
              <td style="text-align: right; width: 30%;"></td>
            </tr>
          </table>
    ...
    $html .= '
      <table style="margin-bottom: 0; width: 100%; margin-top: 36px;">
        <tr>
          <td style="text-align: left;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              '.(date('F j, Y')).'
            </p>
          </td>
        </tr>
      </table>
      <table style="margin-bottom: 0; width: 100%; margin-top: 18px;">
        <tr>
          <td style="text-align: left;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              '.strtoupper($data[0]).'. <b>'.strtoupper($data[1]).''.($data[2] == "" ? "" : " ".strtoupper($data[2][0])).".".' '.strtoupper($data[3]).'</b>
            </p>
          </td>
        </tr>
        <tr>
      ...
      <table style="margin-bottom: 0; width: 100%; margin-top: 18px;">
        <tr>
          <td style="text-align: left;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              Dear '.strtoupper($data[0]).'. '.strtoupper($data[3]).',
            </p>
          </td>
        </tr>
      </table>
      <table style="margin-bottom: 0; width: 100%; margin-top: 18px;">
        <tr>
          <td style="text-align: left;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              I am pleased to notify you of your admission to the Central Luzon State University. We look forward to having you with us and trust that you will find your experience here thoroughly satisfying and rewarding.
            </p>
          </td>
        </tr>
      </table>
      <table style="margin-bottom: 0; width: 100%; margin-top: 18px;">
        <tr>
          <td style="text-align: left;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              Our record on your admission will carry the following information:
            </p>
          </td>
        </tr>
      </table>
    ...
    {
      $html .= '
        <table style="margin-bottom: 0; width: 100%; margin-top: 24px; border: 2px dashed #34495e;">
          <tr>
    ...
    $html .= '
      <table style="margin-bottom: 0; width: 100%; margin-top: 18px;">
        <tr>
          <td style="text-align: left;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              If we can be of further assistance, please do not hesitate to write or see us.
            </p>
          </td>
        </tr>
      </table>
      ...
      <table style="margin-bottom: 0; width: 100%; margin-top: 40px;">
        <tr>
          <td style="text-align: left;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: bold;">
              CESAR V. ORTINERO
            </p>
          </td>
        </tr>
      ...
      <table style="margin-bottom: 0; width: 100%; margin-top: 40px;">
        <tr>
          ...
          <td style="text-align: left; text-align: left; padding-bottom: 20px;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              Approved Date
            </p>
          </td>
        ...
        <tr>
          ...
          <td style="text-align: left; text-align: center; border-bottom: 1px solid #000;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              '.$data[16].'
            </p>
          </td>
        ...
        <tr>
          ...
          <td style="text-align: left; text-align: center; padding-bottom: 10px;">
            <p style="font-family: tahoma; font-size: 12px; font-weight: regular;">
              Department Head
            </p>
          </td>
    ...
    $mpdf->SetHTMLFooter('
      <table width="100%">
          <tr>
              <td style="font-family: roboto; font-size: 8px; font-style: italic;">ACA.OAD.YYY.F.129 (Revision No. 1; June 13, 2022)</td>
          </tr>
      </table>
    ');
    ...
    $mpdf->WriteHTML($stylesheet, 1); // CSS Script goes here.
    $mpdf->WriteHTML($html); //HTML Content goes here.
    $mpdf->Output("Notice-of-Admission.pdf", \Mpdf\Output\Destination::DOWNLOAD);
    //$mpdf->Output('Notice-of-Admission.pdf', 'I');
    
    // $mpdf->WriteHTML($stylesheet, 1); // CSS Script goes here.
    // ob_clean();
    // header('Content-type: application/pdf');
    // header('Content-Disposition: inline; filename="Notice-of-Admission.pdf"');
